...
<body>
  ...
  <div class="container-fluid p-5 bg-primary text-white">
    <div class="d-flex justify-content-between">
        <h2>BookStore</h2>
        <div class="d-flex justify-content-between ">
            <div class="pr-2"><h2><a class="nav-link" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a></h2></div>
            <div class="pl-2"><h2><a class="nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a></h2></div>
...
<?php /**PATH C:\My files\app\xampp\htdocs\BookStore\resources\views/Template.blade.php ENDPATH**/ ?>